    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (menu == 1) {//로그인
                        ...
                        while (true) {
                            ...
                            if (menu == 1) {
                                ...
                                for (PostDTO postDTO : arrayList) {
                                    System.out.println(postDTO.stringList());
                                }
                                ...
                                if (rs != null) {
                                    System.out.println(rs.stringPost());
                                    System.out.println("\n=== 댓글 목록 ===\n댓글내용\t\t닉네임\t작성일");
                ...
                String id = sc.nextLine();
                try {//아이디 체크
                    if (memberDAO.memberCheck(id)) {//아이디 체크
                        System.out.println("사용가능한 아이디입니다");
                        System.out.print("pw 입력>> ");
                        String pw = sc.nextLine();
                        System.out.print("닉네임 입력>> ");
                        String nickName = sc.nextLine();
                        if (memberDAO.nicknameCheck(nickName)) {//닉네임 체크
