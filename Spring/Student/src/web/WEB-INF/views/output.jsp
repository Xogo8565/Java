...
<body>
    <table>
        ...
        <tbody>
        <c:forEach items="${arrayList}" var="studentDTO">
            <tr>
                <th>${studentDTO.no}</th>
                ...
                <td>
                    ...
                    <button class="delete" value="${studentDTO.no}">delete</button>
                    <button class="complete" value="${studentDTO.no}">complete</button>
