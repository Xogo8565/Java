...
public class MessageDAO {
    ...
    public int delete(int[] no) throws Exception {
//        1.
//        return sqlSession.delete("messageMapper.deleteList", no);
            Map<String, int[]> map = new HashMap<>();
            map.put("no",no);
            return sqlSession.delete("messageMapper.deleteList", map);
    }
    ...
    public List<Map<String,Object>> select2() throws Exception {
        return sqlSession.selectList("messageMapper.select2");
    }
}
