...
@WebServlet(name = "search", value = "/search.proc")
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            printWriter.write("<!DOCTYPE html>\n" +
                    ...
                    "        </div>\n" +
                    "        <div class='result'>" +
                    "            <div>"+studentDTO.getNo()+"</div>" +
                    "            <div>"+studentDTO.getName()+"</div>" +
                    "            <div>"+studentDTO.getKor()+"</div>" +
                    "            <div>"+studentDTO.getEng()+"</div>" +
                    "            <div>"+studentDTO.getMath()+"</div>" +
                    "            <div></div>" +
                    "        </div>\n" +
                    "    </div>\n" +
